...
async function AudioProvider({
  ...
  return (
    <>
      <div
        className={`grid w-full px-4 lg:px-8 grid-rows-[1fr_auto_auto] md:grid-rows-[1fr_auto] text-white xl:px-16 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5`}
